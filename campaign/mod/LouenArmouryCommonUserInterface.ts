namespace LouenArmoury {
    ...
    export namespace CommonUserInterface {
        ...
        const logger = new Logger("LouenArmoury CommonUserInterface")
        ...
        export function Destroy(...components: IUIComponent[]) {
            const name = `Destroy_LouenArmoury_${RandomString(5)}`
        ...
        export class MessageBox implements IPopupDialog {
            ...
            readonly identifier = `MessageBox_LouenArmoury_${RandomString(5)}`
